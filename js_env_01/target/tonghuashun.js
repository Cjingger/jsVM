...
window.localStorage = {};
window.setIntervalId = 0;
window.setInterval = function setInterval(f, d) { 
    if (typeof f === "string") f = eval(f);
    f();
    window.setIntervalId++; 
    return window.setIntervalId;
};
...
window.safefunction(Element.prototype.insertBefore);
...
document.head = {};
document.head.insertBefore = function insertBefore(a, b) {
     Element.prototype.insertBefore(a, b)
}
...
navigator.userAgent = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/112.0.0.0 Safari/537.36";

Location = function Location() {};
Location.prototype.href = "https://www.10jqka.com.cn/";
Location.prototype.host = "www.10jqka.com.cn";
...
function get_hexinv() {
          ...
          {src:"https://ai.iwencai.com/mobile/NewHotSpotStocks/indexData?params=jrjh:2&source=wzzttz&callback=jQuery1830834792560458798_1681024717208&_=1681024717538", tagName: "SCRIPT"},
          {src:"https://t.10jqka.com.cn/newcircle/group/getSelfStockWithMarket/?callback=selfStock&_=1681024717503", tagName: "SCRIPT"}
        );
          return window.CJ;
}
// document.head.__defineGetter__("insertBefore", function(){debugger;});

var TOKEN_SERVER_TIME = 1681024000.541;
